...
Rcor=17.5      %coronary resistance  (mmHg/(liter/minute))
...
Csa=0.00065 %Systemic  arterial compliance (liters/mmHg)
Cpa=0.00175  %Pulmonary arterial compliance (liters/mmHg)
...
G(isa,isv)=1/Rs+1/Rcor;   %no valve
G(isv,isa)=1/Rs+1/Rcor;   %no valve
